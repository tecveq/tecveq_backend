...
app.use(
  cors({
    credentials: true,
    origin: isProduction
      ? ["https://tca-frontend-sync-git-main-zees-projects-3a466cf5.vercel.app", "https://tcsravi.educativecloud.com", "https://tcsshalimarbe.educativecloud.com" "*"]  // Production URLs only
      : ["http://localhost:5173", "*"],
